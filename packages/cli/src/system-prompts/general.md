<!--
Purpose: General Agent System Prompt
Description: This is the general-purpose agent system prompt used for researching complex questions and executing multi-step tasks. The agent can execute multiple units of work in parallel and is designed for broad exploration and task execution.
-->
