<!--
Purpose: Build Agent System Prompt
Description: This is the primary coding agent system prompt used for implementing changes, writing code, and executing tasks. The agent is concise, direct, and focuses on actionable guidance.
-->
