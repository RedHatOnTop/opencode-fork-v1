...
const KeybindsSchema = Schema.Struct({
  ...
  system_prompt: keybind("none", "View system prompt sent to the API"),
  ...
  agent_cycle: keybind("tab", "Toggle vibe/spec mode"),
  agent_cycle_reverse: keybind("shift+tab", "Toggle spec/vibe mode"),
  variant_cycle: keybind("ctrl+t", "Cycle model variants"),
  variant_list: keybind("none", "List model variants"),
  thinking_effort_cycle: keybind("ctrl+shift+t", "Cycle thinking effort level"),
  thinking_effort_list: keybind("none", "List thinking effort levels"),
