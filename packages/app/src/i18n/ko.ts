export const dict = {
  ...
  "command.category.provider": "프로바이더",
  ...
  "command.provider.connect": "프로바이더 연결",
  ...
  "dialog.provider.search.placeholder": "프로바이더 검색",
  "dialog.provider.empty": "프로바이더 없음",
  ...
  "dialog.provider.openrouter.note": "모든 지원 모델을 단일 프로바이더에서 액세스",
  ...
  "dialog.model.unpaid.addMore.title": "인기 프로바이더의 모델 추가",
  "dialog.provider.viewAll": "더 많은 프로바이더 보기",
  ...
  "provider.custom.title": "사용자 지정 프로바이더",
  "provider.custom.description.prefix": "OpenAI 호환 프로바이더를 구성합니다. ",
  "provider.custom.description.link": "프로바이더 구성 문서",
  "provider.custom.description.suffix": "를 참조하세요.",
  "provider.custom.field.providerID.label": "프로바이더 ID",
  "provider.custom.field.providerID.placeholder": "myprovider",
  "provider.custom.field.providerID.description": "소문자, 숫자, 하이픈 또는 밑줄",
  "provider.custom.field.name.label": "표시 이름",
  "provider.custom.field.name.placeholder": "내 AI 프로바이더",
  ...
  "provider.custom.error.providerID.required": "프로바이더 ID가 필요합니다",
  "provider.custom.error.providerID.format": "소문자, 숫자, 하이픈 또는 밑줄을 사용하세요",
  "provider.custom.error.providerID.exists": "해당 프로바이더 ID가 이미 존재합니다",
  ...
  "provider.custom.error.fetch": "모델 가져오기 실패",
  "provider.custom.models.fetch": "모델 가져오기",
  "provider.custom.models.fetching": "가져오는 중...",
  "provider.custom.models.search": "모델 검색...",
  "provider.custom.models.toggleAll": "전체 선택",
  "provider.custom.models.selected": "{{total}}개 중 {{count}}개 선택됨",
  "provider.custom.models.noModelsFound": "이 엔드포인트에서 모델을 찾을 수 없습니다",
  ...
  "session.child.promptDisabled": "하위 에이전트 세션은 프롬프트를 입력할 수 없습니다.",
  ...
  "prompt.example.20": "오래된 의존성은 무엇인가요?",
  ...
  "toast.model.none.description": "이 세션을 요약하려면 프로바이더를 연결하세요",
  ...
  "error.chain.checkConfig": "구성(opencode.json)의 프로바이더/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: OpenCode는 아직 MCP 인증을 지원하지 않습니다.',
  "error.chain.providerAuthFailed": "프로바이더 인증 실패 ({{provider}}): {{message}}",
  "error.chain.providerInitFailed": '프로바이더 "{{provider}}" 초기화 실패. 자격 증명과 구성을 확인하세요.',
  ...
  "sidebar.gettingStarted.line2": "Claude, GPT, Gemini 등을 포함한 모델을 사용하려면 프로바이더를 연결하세요.",
  ...
  "settings.general.row.showSearch.description":
    "데스크톱 제목 표시줄에 검색 및 명령 팔레트 버튼 표시",
  ...
  "settings.providers.description": "프로바이더 설정은 여기서 구성할 수 있습니다.",
  "settings.providers.section.connected": "연결된 프로바이더",
  "settings.providers.connected.empty": "연결된 프로바이더 없음",
  "settings.providers.section.popular": "인기 프로바이더",
  ...
  "settings.providers.custom.description": "기본 URL로 OpenAI 호환 프로바이더를 추가합니다.",
